...
final readonly class CreateProductRequest extends Request
{
    public function __construct(
        #[OA\Property(description: 'Повна назва товару', example: 'Apple MacBook Pro 14')]
        #[Assert\NotBlank(message: 'Поле name не може бути порожнє')]
        ...
        #[Assert\NotBlank(message: "Поле 'price' не може бути порожнє")]
