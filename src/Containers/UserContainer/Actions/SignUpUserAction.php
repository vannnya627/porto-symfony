...
final readonly class SignUpUserAction extends Action
{
    public function __construct(
        ...
        private CreateJWTTokenTask $createJWTToken,
    ) {}
    ...
    public function run(UserValue $value): SignUpValue
    {
        ...
        $token = $this->createJWTToken->run($user);

        return SignUpValue::create(userId: $user->id, email: $user->email->value, token: $token);
    }
}
